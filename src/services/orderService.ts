...
//         api.get<OrderDto[]>('/Order', { params }),

//     // جزئیات یک سفارش GET
//     getById: (id: string): Promise<OrderDto> => api.get<OrderDto>(`/Order/${id}`),

//     // ثبت سفارش جدید POST
//     createOrder: (payload: PlaceOrderDto): Promise<OrderDto> =>
//         api.post<OrderDto>('/Order', payload),

//     // لغو سفارش POST
//     cancel: (id: string): Promise<void> => api.post<void>(`/Order/${id}/cancel`, {}),

//     // آیتم‌های یک سفارش GET
//     getLines: (id: string): Promise<OrderLineDto[]> =>
//         api.get<OrderLineDto[]>(`/Order/${id}/lines`),
// };
