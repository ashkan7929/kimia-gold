            ...
            <div className="bg-black min-h-screen p-4.5">
                <header className='bg-primary-darker grid grid-cols-3 w-full rounded-lg py-2.5 px-4 mb-3'>
                    ...
                    <div className='flex justify-center items-center'>
                        <Typography className='font-peyda text-white' fontWeight='bold' fontSize={11}>{title}</Typography>
                    </div>
                        ...
                        <div className='flex flex-col gap-3 py-5 z-20'>
                            {
                                menu.map((item) => (
                                    <div onClick={() => handleNavigate(item.link)} className='bg-primary-darker flex items-center rounded-lg gap-3 p-3 cursor-pointer'>
                                        ...
                                        <div className='grow'>
                                            <Typography className='font-peyda text-white' fontSize={13}>{item.title}</Typography>
                                            <Typography className='font-peyda text-neutral-300 line-clamp-1' fontSize={11}>{item.subtitle}</Typography>
                                        </div>
