...
const menu = [
    ...
    },
    {
        icon: FaRegUser,
        title: 'صندوق پیام‌ها',
        subtitle: 'در این بخش می‌توانید آخرین پیام‌های خود را مشاهده کنید.',
        link: '/message-box',
    },
    {
        icon: FaRegUser,
        title: 'دعوت از دوستان',
        subtitle: ' از این بخش می‌توانید دوستان خود را دعوت کنید.',
        link: '/invite',
    },
    {
        icon: FaRegUser,
        title: 'نظرات و پیشنهادات',
        subtitle: 'نظرات و پیشنهادات خود را از این بخش با ما در میان بگذارید.',
        link: '/suggestions',
    },
    {
        icon: FaRegUser,
        title: 'گزارشات ریز تراکنش‌ها',
        subtitle: 'در این بخش می‌توانید تراکنش‌های خود را مشاهده کنید.',
        link: '/transaction-details',
    },
    {
        icon: FaRegUser,
        title: 'تنظیمات',
        subtitle: 'از این قسمت می‌توانید تغییرات را مشاهده کنید و تغییر دهید.',
        link: '/settings',
    },
    {
        icon: FaRegUser,
        title: 'درباره باشگاه وِم ',
        subtitle: 'در این قسمت می‌توانید اطلاعات بیشتری درباره‌ی باشگاه وم  به‌دست آورید.',
        link: '/about',
    },
    {
        icon: FaRegUser,
...
const Layout = ({ children }: { children: any }) => {
    ...
    return (
        <>
            ...
            {showMenu && (
                <div className="overflow-y-auto fixed top-0 right-0 h-screen w-full bg-primary-dark/90 z-20">
                    ...
                    <div className="flex flex-col p-4.5">
                        <div className="grid grid-cols-3 w-full z-20">
                            ...
                            <div className="flex justify-end">
                                <div className="w-8.5 h-8.5 flex justify-center items-center rounded-full border border-white/50 cursor-pointer" onClick={() => handleNavigate(('/home'))}>
                            ...
                            {menu.map(item => (
                                ...
                                >
                                    ...
                                    <div className="grow">
                                        ...
                                        <Typography
                                            className="font-peyda text-neutral-300 line-clamp-1"
                                            fontSize={10}
                                        >
                                            {item.subtitle}
                                        </Typography>
