    ...
    return (
        <>
            <>
                    ...
                    <header className="px-4">
                        <nav className="mt-4 mb-4 flex h-[54px] px-[15px] justify-between items-center bg-[#010048] rounded-[10px] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                            <div className="flex gap-1">
                                <div>
                                    <button onClick={() => { }} className="bg-transparent flex w-[34px] h-[34px] justify-center items-center rounded-[19.27px] border-[0.704px] border-[#213163] shadow-[0px_0px_35.185px_0px_rgba(255,255,255,0.12)]">
                                        <svg
                            ...
                            <div>
                                <div className="font-['Alibaba'] text-center text-[11px] font-bold leading-normal text-white">دعوت از دوستان</div>
                            </div>
                            <div>
                                <div>
                    ...
                    <main className="flex-1 bg-[url('../images/main-lines-pattern.png')] bg-cover bg-center">
                        <div className="px-4 flex flex-col gap-3 mb-3">
                            <section className="invite">
                                <div className="bg-[#010048] rounded-[10px] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                                    <div className="p-4 flex flex-col gap-2">
                                        ...
                                        <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">دعوت از دوستان</div>
                                        <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                            با دعوت از دوستانتان میتوانید در خرید بعدی طلا خود بدون کارمزد
                                            خرید کنید
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">کد دعوت</label>
                                            <div className="flex gap-2 relative">
                                                <input
                                                    type="text"
                                                    className="form-control flex-1 ps-5"
                                                    placeholder="کد دعوت را وارد نمایید"
                                                />
                                                <button className="inline-block px-2 py-[0.65rem] text-[0.6875rem] font-semibold leading-[150%] text-center no-underline align-middle cursor-pointer select-none border border-transparent rounded-lg bg-[#010048] border-[#010048] text-white flex items-center justify-center gap-2 transition-all duration-150 ease-in-out">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width={25}
                                                        height={25}
                                                    ...
                                                    >
                                                        <path
                                                            fillRule="evenodd"
                                                            clipRule="evenodd"
                                                            d="M15.2715 21.6265H4.27148C3.71948 21.6265 3.27148 21.1785 3.27148 20.6265V9.62646C3.27148 9.07446 3.71948 8.62646 4.27148 8.62646H15.2715C15.8235 8.62646 16.2715 9.07446 16.2715 9.62646V20.6265C16.2715 21.1785 15.8235 21.6265 15.2715 21.6265Z"
                                                            stroke="white"
                                                            strokeWidth="1.5"
                                                            strokeLinecap="round"
                                                            strokeLinejoin="round"
                                                        />
                                                        <path
                                                            d="M21.2715 5.62646V4.62646C21.2715 4.07446 20.8235 3.62646 20.2715 3.62646H19.2715"
                                                            stroke="white"
                                                            strokeWidth="1.5"
                                                            strokeLinecap="round"
                                                            strokeLinejoin="round"
                                                        />
                                                        <path
                                                            d="M21.2715 15.6265V16.6265C21.2715 17.1785 20.8235 17.6265 20.2715 17.6265H19.2715"
                                                            stroke="white"
                                                            strokeWidth="1.5"
                                                            strokeLinecap="round"
                                                            strokeLinejoin="round"
                                                        />
                                                        <path
                                                            d="M7.27148 5.62646V4.62646C7.27148 4.07446 7.71948 3.62646 8.27148 3.62646H9.27148"
                                                            stroke="white"
                                                            strokeWidth="1.5"
                                                            strokeLinecap="round"
                                                            strokeLinejoin="round"
                                        ...
                                        <div className="social-label">اشتراک گذاری :</div>
                ...
                <div className="menu ">
                    <div className="backdrop top-backdrop" />
                    <div className="backdrop bottom-backdrop" />
                    <div className="menu-backdrop" />
                    <nav className="flex items-center justify-between py-3 px-4 bg-transparent">
                        <div>
                            <button>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div>
                            <button onClick={() => { }} className="bg-transparent flex w-[34px] h-[34px] justify-center items-center rounded-[19.27px] border-[0.63px] border-[#B7B7B7] shadow-[0px_0px_31.481px_0px_rgba(255,255,255,0.12)]">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width={14}
                                    height={14}
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        <div className="flex w-[31px] h-[31px] justify-center items-center gap-[10px] rounded-[4px] bg-[#EA8A2A]">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={19}
                                                height={19}
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">اطلاعات کاربری</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">قوانین و مقررات</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">صندوق پیام ها</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">نظرات و پیشنهادات</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">گزارشات ریز تراکنش ها</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">تنظیمات</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">درباره ثروت کیمیا</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="font-['Alibaba'] text-[12px] font-bold leading-[150%] text-white">خروج از حساب کاربری</div>
                                            <div className="text-[#CACACA] text-[10px] font-normal leading-[150%]">
                                                در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                            </div>
                                        </div>
                    ...
                    <div className="fixed bottom-0 left-0 right-0 z-50">
                        <div className="flex justify-center items-center p-4">
                            <button className="flex w-[50px] h-[50px] justify-center items-center rounded-full bg-[#EA8A2A] shadow-lg transition-all duration-300 hover:scale-110">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width={24}
                                    height={24}
