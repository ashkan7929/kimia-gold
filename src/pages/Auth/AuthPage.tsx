                ...
                {currentStep === 'mobile' && (
                    <form
                        onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
                            e.preventDefault();
                            e.stopPropagation();
                            if (mobileForm.formState.isSubmitting) return;
                            mobileForm.handleSubmit(handleMobileSubmit)(e);
                        }}
                        noValidate
                    ...
                    >
                        <div className="flex flex-col gap-2">
                            <Typography
                                className="text-text-color light:text-dark-800"
                            ...
                            <Typography
                                className="text-neutral-300 light:text-dark-600"
                    ...
                    <div className="w-full max-w-md mx-auto">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1 ">
                                <Typography
                                    className="text-color text-tex-color light:text-light-text-color !font-peyda mb-2"
                                    fontSize={12}
                                >
                                    شماره موبایل
                                </Typography>
                ...
                {currentStep === 'password' && (
                    <div className="w-full max-w-md mx-auto">
                        ...
                        >
                            ...
                            <div>
                                <Typography
                                    className="text-color text-text-color light:text-light-text-color !font-peyda mb-2"
                                    fontSize={12}
                                >
                                    شماره موبایل
                                </Typography>
