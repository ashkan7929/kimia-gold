      ...
      <main className="px-4 flex-grow py-5 flex flex-col items-center justify-center bg-[url('/images/Lines-pattern-starters.png')] bg-cover bg-center">
        ...
        {currentStep === 'mobile' && (
          <form
            onSubmit={(e) => {
              e.preventDefault();
              proceedFromMobile('otp'); // ← پیش‌فرض Enter: OTP
            }}
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center text-text-color rounded-xsm dark:border-custom-border-light border-custom-gray border">
                ...
                <input
                  ...
                  type="text"
                  className="text-sm w-full h-10 pr-10 pl-5 dark:bg-black bg-transparent border-custom-gray dark:border-none rounded-lg dark:text-text-color text-light-text-color font-peyda placeholder-custom-text-secondary focus:outline-none dark:focus:border-primary-blue focus:border-light-text-color"
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Button
                ...
                className="w-full text-white bg-primary-blue dark:bg-accent-orange hover:bg-blue-600"
              >
                ورود با کد یکبار مصرف
              </Button>

              {/* فرعی: ورود با رمز عبور (Outline) */}
              <button
                type="button"
