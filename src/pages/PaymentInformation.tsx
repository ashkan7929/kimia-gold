        ...
        <>
            <div className="w-full max-w-[375px] mx-auto bg-primary min-h-screen flex flex-col">
                <header className="px-4">
                    <nav className="mt-4 mb-4 flex h-[3.375rem] px-[0.9375rem] justify-between items-center bg-custom-bg-card rounded-[0.625rem] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                        ...
                        <div>
                            <div className="nav-title">اطلاعات پرداخت</div>
                        </div>
                        <div>
                            <div>
                                <button onClick={() => { }} className="bg-transparent flex w-[2.125rem] h-[2.125rem] justify-center items-center rounded-[1.20438rem] border-[0.704px] border-custom-border shadow-[0px_0px_35.185px_0px_rgba(255,255,255,0.12)]">
                        ...
                        <section className="payment-information">
                            <div className="bg-custom-bg-card rounded-[0.625rem] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                                <div className="p-4 flex flex-col gap-2">
                                    <div className="text-white text-lg font-medium">اطلاعات نهایی برای پرداخت</div>
                                    <ul className="space-y-2">
                                        <li className="flex justify-between items-center border-b border-dashed border-gray-600 pb-2">
                                            <div className="text-gray-300">
                                                مقدار <small>(به تومان)</small>
                                            </div>
                                            <div className="text-white font-medium">2,500,000</div>
                                        </li>
                                        <li className="flex justify-between items-center border-b border-dashed border-gray-600 pb-2">
                                            <div className="text-gray-300">تاریخ و زمان :</div>
                                            <div className="text-white font-medium">15:25 1403/08/15</div>
                                        </li>
                                        <li className="flex justify-between items-center border-b border-dashed border-gray-600 pb-2">
                                            <div className="text-gray-300">نوع تراکنش</div>
                                            <div className="text-white font-medium">خرید طلای 18 عیار</div>
                                        </li>
                                    </ul>
                                    <div className="mb-3">
                                        <label className="block text-white text-sm font-medium mb-2">کد تخفیف</label>
                                        <div className="flex gap-2">
                                            ...
                                            />
                                            <button className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-500 transition-colors">اعمال</button>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <button className="w-full px-4 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-500 transition-colors">
                                        ...
                                        <button className="w-full px-4 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-500 transition-colors">
                                            ارسال لینک پرداخت با پیامک
                                        </button>
                                        <button className="w-full px-4 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-500 transition-colors">
                                            ارسال لینک پرداخت از طریق واتس آپ
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="fixed inset-0 z-50 bg-black bg-opacity-50 hidden">
                ...
                <nav className="flex justify-between items-center p-4 bg-custom-bg-card">
                    <div>
                        <button onClick={() => { }} className="bg-transparent flex w-[2.125rem] h-[2.125rem] justify-center items-center rounded-[1.20438rem] border-[0.704px] border-custom-border shadow-[0px_0px_35.185px_0px_rgba(255,255,255,0.12)]">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        <div className="flex justify-center items-center">
                            <img src="./assets/images/logo/logo.png" alt="logo" className="object-contain" />
                        </div>
                    </div>
                    <div>
                        <button onClick={() => { }} className="bg-transparent flex w-[2.125rem] h-[2.125rem] justify-center items-center rounded-[1.20438rem] border-[0.704px] border-custom-border shadow-[0px_0px_35.185px_0px_rgba(255,255,255,0.12)]">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="text-white font-medium">اطلاعات کاربری</div>
                        ...
                        <div className="p-4">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="text-white font-medium">قوانین و مقررات</div>
                                        <div className="text-gray-400 text-sm">
                        ...
                        <div className="p-4">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="text-white font-medium">صندوق پیام ها</div>
                                        <div className="text-gray-400 text-sm">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="card-body">
                            <div className="flex-between">
                                <div className="flex-center gap-3">
                                    ...
                                    <div className="d-flex flex-column gap-1">
                                        <div className="title">درباره ثروت کیمیا</div>
                                        <div className="subtitle">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
