            ...
            <div className="w-full flex flex-col">
                <main className="flex-1 bg-[url('../statics/assets/images/main-lines-pattern.png')] bg-cover bg-center">
                    <div className="flex flex-col gap-3 mb-3">
                        <section className="">
                            <div className="bg-custom-bg-card light:bg-white rounded-[0.625rem] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                                <div className="p-4 flex items-center gap-2">
                                    <div className="relative">
                                        ...
                                        <div className="relative bg-primary-darker light:bg-white w-[2.875rem] h-[2.875rem] rounded-full overflow-hidden">
                                            <img
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <Typography className="text-text-color light:text-light-text-color !font-alibaba !font-bold !text-4xl-custom">
                                            {userData?.firstName + ' ' + userData?.lastName}
                                        </Typography>
                                        <div className="flex items-center gap-1 ">
                                            <CiMobile3 className="text-text-color light:text-light-text-color" />
                                            <Typography className="text-text-color light:text-light-text-color !font-peyda !text-4xl-custom">
                        ...
                        <Disclosure as="div">
                            {({ open }: { open: boolean }) => (
                                <div
                                    className={`p-1 w-full rounded-lg transition-all duration-700 ease-out bg-custom-bg-card light:bg-white`}
                                >
                                    <div>
                                        <div
                                        ...
                                        >
                                            <Disclosure.Button className="flex justify-between items-center p-4 w-full cursor-pointer">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-text-color light:text-light-text-color font-peyda">
                                                        اطلاعات فردی
                                                    </span>
                                                </div>
                                                {open ? (
                                                    ...
                                                    <div className="flex justify-between items-center gap-6">
                                                        ...
                                                        <div className="w-full py-1 px-1.5 flex justify-center items-center gap-2 rounded-md bg-custom-bg-menu shadow">
                                                            <div className="flex flex-1">
                                                                ...
                                                                <label
                                                                    htmlFor="gender_man"
                                                                    className="h-[1.6875rem] px-[0.5625rem] flex justify-center items-center flex-1 gap-1 rounded-[0.375rem] bg-primary-blue cursor-pointer"
                                                                >
                                                                    ...
                                                                    <span className="text-text-color light:text-light-text-color text-sm font-peyda">
                                                                        مرد
                                                                    </span>
                                                                </label>
                                                            </div>
