            ...
            <div>
                <main className="flex-1">
                    <div className="container flex flex-col gap-3 mx-auto mb-3">
                        <div className="rounded-lg shadow-lg dark:bg-black bg-light-primary-darker">
                            <div className="flex flex-col gap-4 p-4">
                                <div className="font-bold dark:text-text-color text-light-text-color text-md font-alibaba">
                                    صندوق پیام‌ها
                                </div>
