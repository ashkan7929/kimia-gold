    ...
    return (
        <div className="dark:bg-black bg-white">
            ...
            <Disclosure as="div" className="p-1">
                {({ open }) => (
                    <div className="w-full rounded-lg dark:bg-black bg-white transition-all duration-700">
                        <Disclosure.Button className="flex w-full cursor-pointer items-center justify-between p-4">
                            <span className="font-peyda text-xs dark:text-text-color text-light-text-color">
                                اطلاعات سلامت
                            </span>
                            {open ? (
                                <FaChevronUp
                        ...
                        >
                            <Disclosure.Panel as="div" className="overflow-hidden">
                                <div className="flex flex-col gap-3 p-4">
                                    <div>
                                        <label className="mb-2 block font-peyda text-xs font-semibold leading-normal text-text-color">
                                            قد (سانتی‌متر)
                                        </label>
                                        <TextField
                                    ...
                                    <div className="flex items-center gap-0 text-sm dark:text-text-color text-light-bg-input">
                                        <CheckBox defaultChecked label="آیا بیماری خاصی دارید؟" />
                                    </div>
                                    <Tabel className="w-full border-collapse text-right font-peyda">
                                        <thead>
                                            <tr className="dark:bg-light-primary-darker bg-primary-darker">
                                                <th
                                                    scope="col"
                                                    className="border dark:border-gray-300 dark:text-black dark:bg-none text-sm text-center border-gray-700 text-white px-2 py-1"
                                                >
                                                    لیست بیماری‌ها
                                                </th>
                                            </tr>
                                        ...
                                        <tbody className="">
                                            <tr className="light:bg-light-primary-darker bg-black">
                                                <td className="border dark:border-gray-300 dark:text-text-color text-light-text-color text-xs text-center  border-gray-700 px-4 py-2">
                                                    انواع سرطان‌ها مثل سرطان معده
                                                </td>
                                            </tr>
                                            <tr className="bg-light-primary-darker dark:bg-black dark:border-gray-200">
                                                <td className="border dark:border-gray-300 dark:text-text-color text-light-text-color text-xs text-center border-gray-700 px-4 py-2">
                                                    صرع
                                                </td>
                                            </tr>
                    ...
                    <div className="w-full rounded-lg dark:bg-black bg-white transition-all duration-700">
                        ...
                        >
                            <Disclosure.Panel as="div" className="flex gap-2 flex-col">
                                <div>
                                    <Typography
                                        className="dark:text-white text-light-text-color !font-peyda mb-2 mr-2 "
                                        fontSize={12}
                                    >
                                        {' '}
                                        نام
            ...
            <div>
                <Button
                    ...
                    className="font-peyda mt-4 w-full rounded-md bg-accent-orange light:bg-primary-blue text-sm text-white"
                >
                    ادامه
                </Button>
                <div>
                    ...
                    >
                        <div className="flex flex-col items-center justify-center gap-4 p-4">
                            <p className="font-peyda text-lg font-semibold dark:text-white text-gray-800">
            ...
            <Link to="/products/:id/card">
                <Button
                    className="
                font-peyda mt-4 w-full rounded-md text-sm text-white
                bg-primary-blue
                dark:!bg-black dark:border dark:border-gray-500
                "
                >
                    ثبت اطلاعات
                </Button>
