...
const items = [
    ...
    { label: 'کد رهگیری', value: 'WLX-zd4Ak4xEM' },
    {
        label: 'وضعیت',
        value: (
            <span className="flex h-[1.6365rem] px-[0.99413rem] py-[0.35088rem] justify-center items-center gap-[0.58475rem] rounded-[0.3015rem] text-center text-[0.66675rem] font-bold leading-[120%] text-green-500 bg-green-900/20">
                موفق
            </span>
        ),
        border: false,
    ...
    return (
        <div className="w-full mx-auto" dir="rtl" lang="fa">
            <div className="w-full mx-auto bg-[#040320] min-h-screen flex flex-col">
                <header>
                    <div
                        className="font-['Alibaba'] h-[11.5rem] w-full text-white text-[1.08331rem] font-bold leading-normal text-center flex items-center justify-center flex-col gap-[1.125rem] bg-green-500"
                        style={{
