    ...
    return (
        <>
            <div className="w-full max-w-[375px] mx-auto bg-[#040320] min-h-screen flex flex-col">
                <header className="px-4">
                    <nav className="mt-4 mb-4 flex h-[3.375rem] px-[0.9375rem] justify-between items-center bg-[#010048] rounded-[0.625rem] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                        ...
                        <div>
                            <div className="font-[Alibaba] text-center text-[0.6875rem] font-bold leading-normal text-white">جزئیات تراکنش</div>
                        </div>
                        <div>
                            <div>
                ...
                <main className="flex-grow bg-[url('../images/main-lines-pattern.png')] bg-cover bg-center">
                    <div className="px-4 flex flex-col gap-3 mb-3">
                        <section>
                            <div className="bg-[#010048] rounded-lg shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                                <div className="p-4 flex flex-col gap-2">
                                    <div className="text-white font-semibold text-sm mb-2">اطلاعات نهایی برای پرداخت</div>
                                    <ul className="space-y-3">
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">تاریخ و زمان :</div>
                                        ...
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">نوع تراکنش</div>
                                            <div className="text-white text-xs font-medium">خرید طلای 18 عیار</div>
                                        </li>
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">نوع واریز</div>
                                            <div className="text-white text-xs font-medium">عادی</div>
                                        </li>
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">شماره قرارداد</div>
                                            <div className="text-white text-xs font-medium">53465490923167</div>
                                        </li>
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">شماره کارت</div>
                                            <div className="text-white text-xs font-medium">6219861909432576</div>
                                        </li>
                                        <li className="flex justify-between items-center py-2 border-b border-dashed border-gray-600">
                                            <div className="text-gray-300 text-xs">کد رهگیری</div>
                                            <div className="text-white text-xs font-medium">WLX-zd4Ak4xEM</div>
                                        </li>
                                        <li className="flex justify-between items-center py-2">
                                            <div className="text-gray-300 text-xs">وضعیت</div>
                                            <div className="text-white text-xs font-medium">
                                                <span className="inline-flex justify-center items-center px-2 py-1 rounded-[0.24569rem] bg-red-900/20 text-red-400 text-[0.49138rem] font-semibold">ناموفق</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="flex flex-col gap-2 mt-3">
                                <button className="w-full h-[2.4375rem] px-4 py-2 flex justify-center items-center gap-2 rounded-lg bg-gray-600 hover:bg-gray-700 text-white font-semibold text-sm transition-colors duration-200">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={20}
                                        height={20}
                                    ...
                                    >
                                        ...
                                        />
                                        <path
                                            d="M14.1662 10L9.9987 14.1675L5.83203 10"
                                            stroke="white"
                                            strokeWidth="1.25"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                ...
                                <button className="w-full h-[2.4375rem] px-4 py-2 flex justify-center items-center gap-2 rounded-lg bg-[#2256FF] hover:bg-blue-600 text-white font-semibold text-sm transition-colors duration-200">
                                    بازگشت به صفحه اصلی
                                </button>
                            </div>
                        </section>
            ...
            <div className="invisible opacity-0 transition-all duration-200 ease-in-out w-full max-w-[375px] flex flex-col overflow-hidden fixed inset-0 z-[1000] mx-auto min-h-screen">
                <div className="absolute -top-4 right-0 left-0 w-full h-[8.5rem] bg-[#2256FE] blur-[30px]" />
                <div className="absolute -bottom-4 right-0 left-0 w-full h-[8.5rem] bg-[#2256FE] blur-[30px]" />
                <div className="absolute inset-0 bg-[rgba(1,0,86,0.01)] backdrop-blur-[30px]" />
                <nav className="mt-4 mb-4 flex h-[3.375rem] px-[0.9375rem] justify-between items-center relative z-10">
                    <div>
                    ...
                    <div>
                        <button onClick={() => { }} className="bg-transparent flex w-[2.125rem] h-[2.125rem] justify-center items-center rounded-[1.20438rem] border-[0.63px] border-[#B7B7B7] shadow-[0px_0px_31.481px_0px_rgba(255,255,255,0.12)]">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={14}
                                height={14}
                ...
                <div className="px-4 flex flex-col gap-2 flex-grow overflow-auto relative z-10">
                    <div className="bg-[#010048] rounded-lg shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">اطلاعات کاربری</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">قوانین و مقررات</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">صندوق پیام ها</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="title">دعوت از دوستان</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="title">نظرات و پیشنهادات</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                            ...
                            <div className="flex-between">
                                <div className="flex-center gap-3">
                                    ...
                                    <div className="d-flex flex-column gap-1">
                                        <div className="title">گزارشات ریز تراکنش ها</div>
                        ...
                        <div className="card-body">
                            <div className="flex-between">
                                <div className="flex-center gap-3">
                                    ...
                                    <div className="d-flex flex-column gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">تنظیمات</div>
                                        <div className="subtitle">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="card-body">
                            <div className="flex-between">
                                <div className="flex-center gap-3">
                                    ...
                                    <div className="d-flex flex-column gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">درباره ثروت کیمیا</div>
                                        <div className="subtitle">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="card-body">
                            <div className="flex-between">
                                <div className="flex-center gap-3">
                                    ...
                                    <div className="d-flex flex-column gap-1">
                                        <div className="title">خروج از حساب کاربری</div>
                                        <div className="subtitle">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
