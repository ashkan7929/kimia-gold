    ...
    return (
        <>
            <div className='flex flex-col gap-3 items-center pb-25'>
                <div className='bg-primary-blue flex w-full p-4 rounded-lg'>
                    <main
                        className="flex-grow flex gap-3 flex-col bg-[url('/images/Lines-pattern-starters.png')] bg-cover bg-center"
                    >
                        <div className='flex justify-between'>
                            <div>
                                <div className='flex items-center gap-1'>
                                    <img alt='' src='/images/ki-logo.svg' width={34} height={34} />
                                    <Typography className='!font-peyda text-white' fontWeight={600} fontSize={11}>{'کیف پول'}</Typography>
                                </div>
                                <div className='flex gap-1 items-center'>
                                    <Typography className='!font-peyda text-white' fontWeight='bold' fontSize={24}>2,566,890</Typography>
                                    <img alt='' src='/images/toman.svg' width={22} height={17} />
                                </div>
                            </div>
                            <div>
                                <img alt='' src='/images/wallet.svg' width={96} height={76} />
                            </div>
                        </div>
                        <div className='grid grid-cols-3 gap-1'>
                            <button onClick={handleShowDepositModal} className='bg-accent-orange text-white text-[10px] font-peyda px-2 py-1.5 rounded-md flex items-center justify-center gap-0.5'>
                                {'افزایش موجودی'}
                                <GoArrowUpRight className='text-white' fontSize={15} />
                            </button>
                            <button onClick={handleShowWithdrawModal} className='bg-primary-dark text-white text-[10px] font-peyda px-2 py-1.5 rounded-md flex items-center justify-center gap-0.5'>
                                {'برداشت موجودی'}
                                <GoArrowDownLeft className='text-white' fontSize={15} />
                            </button>
                            <button onClick={handleShowTransferModal} className='bg-primary-light text-white text-[10px] font-peyda px-2 py-1.5 rounded-md flex items-center justify-center gap-0.5'>
