    ...
    return (
        <>
            <div className="w-full max-w-[375px] mx-auto bg-[#040320] min-h-screen flex flex-col">
                <header className="px-4">
                    <nav className="mt-4 mb-4 flex h-[3.375rem] px-[0.9375rem] justify-between items-center bg-[#010048] rounded-[0.625rem] shadow-[0px_0px_67px_0px_rgba(0,0,0,0.09)]">
                        ...
                        <div>
                            <div className="font-[Alibaba] text-center text-[0.6875rem] font-bold leading-normal text-white">درباره ما</div>
                        </div>
                        <div>
                            <div>
                ...
                <main className="flex-grow bg-cover bg-center" style={{ backgroundImage: "url('../statics/assets/images/main-lines-pattern.png')" }}>
                    <div className="px-4 flex flex-col gap-3 mb-3">
                        <section className="">
                            <div className="bg-white rounded-lg border border-gray-100 shadow-[0px_0px_91.921px_0px_rgba(0,0,0,0.08)]">
                                <div className="p-4 flex flex-col gap-2">
                                    <div className="text-center relative w-56 h-[8.25rem] mx-auto my-4 flex items-center justify-center">
                                        <div className="w-24 h-24">
                                            <img src="./assets/images/logo/logo.png" alt="" className="w-full h-full object-contain" />
                                        </div>
                                        <div className="absolute inset-0">
                                            <img src="./assets/images/about-group-icon.png" alt="" />
                                        </div>
                                    </div>
                                    <div className="text-black text-center font-[Alibaba] text-[1.0625rem] font-bold leading-normal shadow-[0px_0px_64px_rgba(245,245,245,0.06)] my-3">درباره ما</div>
                                    <div className="text-black text-right font-[0.875rem] font-normal leading-[2] shadow-[0px_0px_64px_rgba(245,245,245,0.06)] mb-3">
                                        <p className="mb-2">
                                    ...
                                    <div>
                                        <button className="bg-[#2256FF] text-white border-none rounded-lg px-4 py-2 w-full font-medium">
            ...
            <div className="invisible opacity-0 transition-all duration-200 ease-in-out w-full max-w-[375px] flex flex-col overflow-hidden fixed inset-0 z-[1000] mx-auto min-h-screen">
                <div className="absolute right-0 left-0 w-full h-[8.5rem] bg-[#2256FE] blur-[30px] -top-4" />
                <div className="absolute right-0 left-0 w-full h-[8.5rem] bg-[#2256FE] blur-[30px] -bottom-4" />
                ...
                <div className="px-4 flex flex-col gap-2 flex-grow overflow-auto">
                    <div className="bg-[#010048] rounded-lg border border-gray-100">
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="flex w-[1.9375rem] h-[1.9375rem] justify-center items-center gap-[0.625rem] rounded-[0.25rem] bg-[#EA8A2A]">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={19}
                                            height={19}
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">دعوت از دوستان</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">نظرات و پیشنهادات</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">گزارشات ریز تراکنش ها</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
                    ...
                    <div className="bg-[#010048] rounded-lg border border-gray-100">
                        <div className="p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="flex w-[1.9375rem] h-[1.9375rem] justify-center items-center gap-[0.625rem] rounded-[0.25rem] bg-[#FF5757]">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={19}
                                            height={19}
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="font-[Alibaba] text-[0.75rem] font-bold leading-[150%] text-white">خروج از حساب کاربری</div>
                                        <div className="text-[#CACACA] text-[0.625rem] font-normal leading-[150%]">
                                            در این بخش میتوانید قوانین و مقررات را مشاهده کنید.
                                        </div>
                                    </div>
