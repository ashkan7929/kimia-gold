...
const MessageBox = () => {
    ...
    return (
        ...
        <>
                ...
                <header className="container mx-auto px-4">
                    <nav className="flex justify-between items-center py-4">
                        <div className="flex gap-1">
                            <div>
                                <button onClick={toggleMenu} className="p-2 rounded-lg bg-blue-800 hover:bg-blue-700 transition-colors">
                                    <svg
                        ...
                        <div>
                            <div>
                                <button className="p-2 rounded-lg bg-blue-800 hover:bg-blue-700 transition-colors">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={14}
                                        height={14}
                                ...
                                <ul className="space-y-0">
                                    <li className="flex items-center gap-3 py-3 border-b border-blue-800 last:border-b-0">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="text-gray-300 text-sm">1404/09/08 12:20</div>
            ...
            <div className="fixed inset-0 z-50 bg-black bg-opacity-50 hidden" id="menu-overlay">
                ...
                <div className="relative h-full flex flex-col">
                    ...
                    <div className="container mx-auto px-4 flex flex-col gap-2 flex-1 overflow-auto">
                        <div className="bg-blue-900 rounded-lg shadow-lg border border-blue-800">
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 flex items-center justify-center bg-blue-800 rounded-lg">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={19}
                                                height={19}
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white font-semibold">اطلاعات کاربری</div>
                        ...
                        <div className="bg-blue-900 rounded-lg shadow-lg border border-blue-800">
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 flex items-center justify-center bg-orange-500 rounded" style={{ backgroundColor: '#EA8A2A' }}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={19}
                                                height={19}
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>قوانین و مقررات</div>
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>صندوق پیام ها</div>
                                            <div className="text-gray-300 text-xs" style={{ color: '#CACACA' }}>در این بخش میتوانید قوانین و مقررات را مشاهده کنید.</div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>دعوت از دوستان</div>
                                            <div className="text-gray-300 text-xs" style={{ color: '#CACACA' }}>در این بخش میتوانید قوانین و مقررات را مشاهده کنید.</div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>نظرات و پیشنهادات</div>
                                            <div className="text-gray-300 text-xs" style={{ color: '#CACACA' }}>در این بخش میتوانید قوانین و مقررات را مشاهده کنید.</div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>گزارشات ریز تراکنش ها</div>
                                            <div className="text-gray-300 text-xs" style={{ color: '#CACACA' }}>در این بخش میتوانید قوانین و مقررات را مشاهده کنید.</div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-white text-xs font-bold" style={{ fontFamily: 'Alibaba' }}>تنظیمات</div>
                                            <div className="text-gray-300 text-xs" style={{ color: '#CACACA' }}>در این بخش میتوانید قوانین و مقررات را مشاهده کنید.</div>
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div className="bg-blue-900 rounded-lg shadow-lg border border-blue-800">
                            <div className="p-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 flex items-center justify-center bg-red-500 rounded" style={{ backgroundColor: '#FF5757' }}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={19}
                                                height={19}
